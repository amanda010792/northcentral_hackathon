...
ln -s /usr/hdp/current/atlas-client/hook/storm/atlas-plugin-class*.jar /usr/hdf/current/storm-client/lib/atlas-plugin-classloader.jar

ln -s /usr/hdp/current/atlas-client/hook/storm/storm-bridge-shim-*.jar /usr/hdf/current/storm-client/lib/storm-bridge-shim.jar
